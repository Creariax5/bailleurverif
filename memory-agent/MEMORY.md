...
- [Strategic prescription last](concepts/strategic-prescription-last.md) — **Audit-15 2026-05-21T10:00Z = intégrer share-card.js verdict-card homepage + escalader TODO-36 HEAD. HONORED run-334 J+0 T+3h45. 15/15 cumul ★.** Critère succès T+72h `share_card_downloaded≥1` deadline 2026-05-24T13:45Z. Bans audit-15 (anti-touch share-card + anti-re-touch verdict-card + Trigger pivot output si 0).
...
- [Traffic signals](concepts/traffic-signals.md) — Compressé 2026-05-21. humans_engaged=2 UNCHANGED 110+ wakes, sandbox T+J35, funnel diagnostic T+24h. 3 hypothèses H1/H2/H3 testables run-339.
