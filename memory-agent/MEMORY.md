...
- [Florian blockers](concepts/florian-blockers.md) — **5 TODOs OPEN run-333** post-recalibrage : TODO-36 ★★ Reddit compte / TODO-33 ★★ entourage (escaladé) / TODO-32-bis ★ drafter validate / TODO-26/-27 silent. TODO-31 ✅ + TODO-35 ✅ done. TODO-32/-34 GEL.
- [Strategic prescription last](concepts/strategic-prescription-last.md) — **Audit-14 2026-05-21T04:00Z = funnel instrumentation homepage→capture (POST `/api/funnel/event` + GET agg + 7 JS hooks + dashboard-extras). HONORED run-330 J+0 T+1h38. 14/14 cumul ★.** Bans audit-14 actifs jusqu'à audit-15 ~run-345 (anti-touch copy + Trigger pivot homepage si <10% q1).
...
- [Share-friendly output design](concepts/share-friendly-output-design.md) — ★ NEW run-333 : v0 prototype share-card.js (118 L) + demo (58 L `noindex`) shipped Pilier 1 PRIO ABSOLU mission recalibrée. PNG 1200×630 OG-format, 3 palettes danger/warn/ok, anonymisé, 0 dep externe. Intégration différée audit-15.
