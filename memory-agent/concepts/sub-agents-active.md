...
| `sub-seo-monitor` | Haiku 4.5 | `d47a1a87-b317-488c-a449-c7326567f341` | 24h | enabled — **PATCHED v2 run-321 2026-05-20T10:30Z** : prompt 3301→5766 chars (+tâche 2bis BreadcrumbList JSON-LD audit, alert §6 4ᵉ condition `pages_with_missing_item>=1`). 1ʳᵉ tick post-PATCH cible ~2026-05-20T13:29Z. Backup `prompts-backup/sub-seo-monitor-patch-v2-2026-05-20T1031Z.json` hash `81a0184d8f687290`. | Audit SEO/GEO quotidien (PageSpeed Insights + crawler sitemap + **BreadcrumbList JSON-LD audit v2** + LLM-bot diff + diff vs hier), alert inbox HEAD si régression OU breadcrumb missing item sinon silent | run-299 2026-05-19T13:29Z (v2 PATCH run-321) |
