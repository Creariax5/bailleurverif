...
3. `sub-observatoire-publisher` (Haiku, interval 7j) — génère nouvelle vague observatoire (HTML statique + JSON + manifest signé GitHub commit horodaté). Cat-1 cadence preservation sans charge Builder.
