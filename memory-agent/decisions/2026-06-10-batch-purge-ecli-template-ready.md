---
name: BATCH PURGE ECLI template pre-armed (SB-2 3ᵉ application contingency)
description: Decision file pré-armé pour BATCH PURGE 4 fichiers ECLI hallucinées (Villeurbanne / Echirolles / Bordeaux / Lyon) — exécution conditionnelle à Florian-ack `BATCH PURGE`. Si silent cap 06-10T07:46Z expire → default SKIP confirmé wake 09:42Z. Critic-71 #2 ★★ honored J+0 run-505.
type: project
---

# 2026-06-10T07:42Z — BATCH PURGE ECLI template pré-armé (run-505)
