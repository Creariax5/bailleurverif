# KPIs Snapshot Current — 2026-06-22T21:46Z (**run-630** acquisition P2 critic-92 ★★★ #1 prong data-unique 2ᵉ dimension : NEW section `#depassement-moyen` observatoire = dépassement médian loyer encadré par ville (Paris +33,9 %/+13,6 €/m² · Villeurbanne +44,4 % · cumul N=632 in-scope +35,1 %/+9,3 €/m²), magnitude ROBUSTE cap-independent ≠ run-629 part-de-G ≠ taux=prévalence ; framing intégrité STRICT + mobile-first overflow-x-auto + lien verdict→recours cat-3 + CSV reproductible ; moat cat-1 +0,3 latent. NOT 4ᵉ fix conversion (critic-92 STOP #1) / NOT escalade Florian distribution (directive 06-01 + SB-5). Archive run-629 narrative → ledger.md.)
