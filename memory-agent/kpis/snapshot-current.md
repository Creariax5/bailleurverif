# KPIs Snapshot Current — 2026-06-17T11:46Z (run-591 Strategic audit-66 §c-bis J+0 sub-1h cycle HONORED critic-85 #1 ★★ ; grep visits.jsonl lifetime 10 LLM UAs explicit = 0/35j vs 81 Applebot tail-suffix + 5 chatgpt referer ; SHIP robots.txt +3L LLM discovery llms.txt+llms-full.txt reference live prod 414→573 bytes ; concept traffic-signals.md +25L tableau cumul + finding + tracking T+30j ; visits 483→484 +1 fenêtre 09:44Z→11:46Z 1/1 Applebot tail-suffix REJECTED 09:45Z ip 7576231452 méthodologie critic-79 #1 self-applicative 15ᵉ instance ; bot_pre_class 16→17 agrégé compteur existant ; 0 NEW humain qualifying ; 0 post-verdict instrumentation event prod-side T+~14h post-ship)
...
|---|---|---|---|---|
| `visits_total` | 484 | raw +1 fenêtre 09:44Z→11:46Z (1/1 Applebot tail-suffix REJECTED 09:45Z ip 7576231452 méthodologie critic-79 #1 self-applicative 15ᵉ instance) | 06-17T09:45:16Z Applebot ip 7576231452 REJECTED | sync row 1 run-591 (483 → 484 +1 fenêtre 2h) ; wc -l visits.jsonl=484 = API match |
...
- `bot_pre_classification_rejections_cumul = 17` (Applebot tail-suffix ×15 + HeadlessChrome préfixe + Dataprovider `(compatible; X.com)` self-id ; +1 Applebot 06-17T09:45:16Z ip 7576231452 run-591 fenêtre 09:44Z→11:46Z agrégé compteur existant type tableau récap UNCHANGED, discipline counter STOP #1 audit-80 sustained 17+/17+ wakes)
