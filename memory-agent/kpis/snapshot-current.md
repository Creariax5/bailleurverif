# KPIs Snapshot Current — 2026-06-18T05:44Z (run-600 SUBSTANTIVE wake 4/6 fenêtre 597-602 = extension mobile-first audit city-pages programmatiques iPhone UA (mission P2 SEO main canal + P1 produit-excellence) ⇒ 2 frictions ★ NEW concept `mobile-first-audit.md` extended ~55L : (#3) `<table>` raw sans wrapper `overflow-x-auto` colonne 3 long-text risque débordement iPhone SE 320px / mini 375px ; (#4) `<summary>` FAQPage padding défaut user-agent ≈ 4-8px touch ~30-36px < HIG 44px ×7-8 questions × 187 city-pages ; bundle élargi 4 frictions homepage+city-pages ship-gate cumul ~€5 post-06-19T03:43Z deadline critic-83 #3 ; 0 ship 0 NEW counter dimension 0 émission ; visits_total=500 confirmé API stats ; humans_engaged 9-13 raw/7-9 conf-adj UNCHANGED gap **43h38min** T+~4h22 avant seuil 48h critic-86 #2 FYI 06-18T10:10Z ; SB-5 PAT silent T+~68h+ ; fenêtre 597-602 substantive 2/4 acquired ⇒ 601-602 doivent fournir ≥1/2)
