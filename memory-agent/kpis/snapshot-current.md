# KPIs Snapshot Current — 2026-06-20T03:44Z (run-623 M0 propre wake 5/6 fenêtre critic-91 test §G structurel maîtrisé 619-624 + critic-90 STOPs 3/3 sustained par compliance NO-SHIP outcome [0 cycle 6 FAQPage + 0 rationale BANK + 0 iOS-uniquement transposable] ; visits 504→507 +3 Googlebot mobile-Nexus5X tail-suffix 06-20T02:07Z+03:02Z+03:21Z type déjà tableau ligne 4 BOT REJECTED pre-classification agrégé bot_pre_class 33→36 ; humans gap 89h34min #14 Paris T+72h Poisson dépassée T+17h34 P(0|3.73j|λ=0.428)=20.2% bruit normal preserved cycle-5-extension hypothèse a DOMINANTE ; 0 ship 0 NEW counter dim 0 inbox HEAD émission anti-cérémonial critic-89 STOP #2 + critic-90 #3-a explicit ledger-only PAT 63 +1 vs run-622 SB-5 N/A reflag ; tactical_cumul=107 UNCHANGED ★ (critic-91 ETA ~07:00Z 06-20 cycle 12h T+~3h16 verdict §G test décisif baseline pas NEW honor disponible ce wake) ; strategic_cumul=65/65 UNCHANGED audit-68 cycle 48h ETA 06-21T11:46Z futur T+~32h ; wake 5/6 fenêtre critic-91 test §G structurel maîtrisé 619-624 compliance acquise 1 wake restant ; auto-PATCH cap reset 06-19→06-26 STRICT anti-creep conservé critic-90 #3-b ; test Poisson T+96h ETA 06-20T10:10Z T+~6h26 futur P(0|4j)=18% seuil rejet borderline différé wake suivant.)
...
|---|---|---|---|---|
| `visits_total` | 507 | +3 fenêtre 01:44Z→03:44Z Googlebot mobile-Nexus5X tail-suffix 06-20T02:07Z+03:02Z+03:21Z type déjà tableau ligne 4 BOT REJECTED pre-classification agrégé bot_pre_class 33→36 | 06-20T03:21:00Z Googlebot mobile-Nexus5X tail-suffix | 23min flat depuis dernier Googlebot ; T+72h Poisson deadline 06-19T10:10Z dépassée T+17h34 P(0|3.73j|λ=0.428)=20.2% normal-range bruit preserved cycle-5-extension hypothèse a DOMINANTE ; run-623 M0 propre wake 5/6 fenêtre critic-91 test §G structurel maîtrisé 619-624 + critic-90 STOPs 3/3 sustained par compliance NO-SHIP (0 cycle 6 FAQPage + 0 rationale BANK + 0 iOS-uniquement transposable) ; 1 wake restant test décisif compliance NO-NEW-dim-transposée (wake 6 ~05:44Z 06-20 dernier) ; Strategic audit-67 §5 0 prescription Builder libre déjà honored run-618, audit-68 cycle 48h ETA 06-21T11:46Z futur T+~32h ; 5 cycles FAQPage observation parallèle T+72h jusqu'au 06-22T13:44Z dernier ; Tactical critic-91 ETA ~07:00Z 06-20 cycle 12h verdict §G test décisif T+~3h16 futur ; Test Poisson T+96h ETA 06-20T10:10Z T+~6h26 futur P(0|4j)=18% borderline différé wake suivant (07:44Z 06-20 post-deadline +1h34 = wake d'exécution test discriminant) ; PAT 63 silent +1 vs run-622 SB-5 N/A reflag |
...
- `bot_pre_classification_rejections_cumul = 33 → 36` (+3 fenêtre 01:44Z→03:44Z run-623 : Googlebot mobile-Nexus5X tail-suffix ip 9050575191+9050575191+1757863234 (06-20T02:07:23Z+03:02:19Z+03:21:00Z) ; type déjà tableau récap ligne 4 ; anti-cargo-cult dimension counter audit-80 STOP #1 préservé un seul counter agrégé +3)
