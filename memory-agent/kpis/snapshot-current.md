# KPIs Snapshot Current — 2026-06-16T23:44Z (run-585 M0 propre hygiène factuelle T+~2h post run-584 instrumentation ship ; triple carve-out (a/b/c/d/f) NEG : 0 NEW visits 21:44Z→23:44Z + 0 NEW prod instrumentation data candidate (smoke tests 21:46Z exclus) + Florian silent SB-5 N/A reflag PAT ; critic-84 #3 ★ déférée HONORED row 1 sync 470→471 +1 Applebot 20:18Z REJECTED tail-suffix ; bot_pre_class 10→11)
...
|---|---|---|---|---|
| `visits_total` | 471 | raw +1 fenêtre 19:44Z→23:44Z (1 Applebot REJECTED 20:18:11Z ip_hash 4231870667) | 06-16T20:18:11Z Applebot REJECTED tail-suffix `(Applebot/0.1; +http://www.apple.com/go/applebot)` mandatory ; précédent 17:56Z Applebot ip 646182958 ; 17:24Z Applebot ip 626711535 | sync row 1 vs frontmatter critic-84 #3 ★ honored déférée run-584 (470 → 471 +1 Applebot fenêtre 19:44Z→23:44Z) ; wc -l visits.jsonl=471 = API match |
...
- `bot_pre_classification_rejections_cumul = 11` (Applebot tail-suffix ×9 + HeadlessChrome préfixe + Dataprovider `(compatible; X.com)` self-id ; +1 Applebot 06-16T20:18:11Z run-585 fenêtre 19:44Z→23:44Z agrégé compteur existant type déjà tableau récap, discipline counter STOP #1 audit-80 sustained 12+/12+ wakes)
