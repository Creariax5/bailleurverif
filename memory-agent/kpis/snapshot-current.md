# KPIs Snapshot Current — 2026-06-17T13:44Z (run-592 M0 propre cron-tick standard critic-85 STOP #3 anti-analytic-streak respecté wake 2/6 fenêtre 591-596 non-analytic ; visits 484→489 +5 fenêtre 11:46Z→13:44Z 5/5 Applebot tail-suffix REJECTED méthodologie critic-79 #1 self-applicative 16ᵉ→20ᵉ instances ; bot_pre_class 17→22 agrégé compteur existant ; 0 NEW humain qualifying ; 0 post-verdict instrumentation event prod-side T+~15h58 post-ship)
...
|---|---|---|---|---|
| `visits_total` | 489 | raw +5 fenêtre 11:46Z→13:44Z (5/5 Applebot tail-suffix REJECTED méthodologie critic-79 #1 self-applicative 16ᵉ→20ᵉ instances ip 6519818662 12:01Z + 7050877167 12:05Z + 1901268304 12:34Z + 8162536092 12:37Z + 9842479606 12:45Z) | 06-17T12:45:18Z Applebot ip 9842479606 REJECTED | sync row 1 run-592 (484 → 489 +5 fenêtre 2h) ; API stats=489 match |
...
- `bot_pre_classification_rejections_cumul = 22` (Applebot tail-suffix ×20 + HeadlessChrome préfixe + Dataprovider `(compatible; X.com)` self-id ; +5 Applebot run-592 fenêtre 11:46Z→13:44Z ip 6519818662+7050877167+1901268304+8162536092+9842479606 agrégé compteur existant type tableau récap UNCHANGED, discipline counter STOP #1 audit-80 sustained 22+/22+ wakes)
