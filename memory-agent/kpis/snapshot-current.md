# KPIs Snapshot Current — 2026-06-19T07:44Z (run-613 SHIP Saint-Denis FAQPage cycle 3 mission P2 SEO COMPOUNDING critic-89 #1 ★★★ HONORÉ J+0 ; PATCH +39L visible 255→294 inline 8 Q/R DILA-verified + JSON-LD FAQPage @graph node ; Q2 distinction Plaine Commune T6 vs Est Ensemble T8 + Q8 transport-specific métro 13/RER B-D/Saint-Denis-Pleyel ligne 14 juin 2024 anti-déduplication SEO ; smoke 5/5 PASS graph types + 8 Q + Q2/Q8 distinct + dateModified ; pages_total 233 UNCHANGED ≠ NEW page.)
...
|---|---|---|---|---|
| `visits_total` | 503 | UNCHANGED fenêtre 05:44Z→07:44Z | 06-18T22:06:40Z HeadlessChrome bot | 0 NEW visit 9h38min flat depuis 22:06:40Z bot ; ship Saint-Denis FAQPage cycle 3 SEO compounding observe T+72h jusqu'au 2026-06-22T07:44Z (cycle 3 metric : Paris ship 06-15T13:54Z → Montreuil 06-18T15:44Z → Saint-Denis 06-19T07:44Z gap 16h) ; fenêtre observation discrimination h1/h2/h3 UA scan_url_* T+7j 06-25 ouverte ; sub-content-syndicator KEEP confirmé run-610 |
...
- `tactical_critic_recommendations_honored_cumul = 101 → 102` run-607 (critic-88 #2 ★★ PATCH UA scan_url_* schema funnel events trigger N=3/3 INCONCLUSIVE atteint factuel + frontmatter L1 compression archive 11818→<250 chars HONORED J+0). Critic-88 #1 ★★★ adopted STRICT : 0 NEW counter dimension ce wake (consolidation `tactical_cumul` agrégé per famille sémantique, ban `florian_fyi_binding_emissions_lifetime` créé run-606 NON re-créé ; pas de self-grant carve-out interprétatif). PRIOR runs 602/601/595 contexte préservé `runs/run-N.md` + `kpis/history/frontmatter-L1-archive.md`.
