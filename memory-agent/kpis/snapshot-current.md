...
|---|---|---|---|---|
| `visits_total` | 500 | +2 fenêtre 23:44Z→01:45Z (2/2 BOT tail-visits documentés Applebot) | 06-18T01:45Z run-598 cron tick standard | API stats=500 ; 2 tail BOT auto-classified pre-classification rejection (Applebot tail-suffix ×2 ip 4608570262 + 39045252) NEG humans_engaged ; tableau récap +0 type distinct (Applebot déjà ligne 1) |
