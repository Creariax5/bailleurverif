# KPIs Snapshot Current — 2026-06-18T07:44Z (run-601 SUBSTANTIVE wake 5/6 fenêtre 597-602 = test discriminant Mann-Whitney U cadence verdict_displayed PRE vs POST FAQPage cycle 1 (critic-87 #1 ★★★ honored J+0 T+~44min, mission P3 MESURE explicit). 14 events verdict_displayed lifetime → 10 distinct ip_hash humains qualifying (post smoke exclu). Split Paris FAQPage ship 2026-06-15T13:54Z : **PRE 23.39j N=10 rate 0.428/j inter-arrivals médiane 2.93j** / **POST 2.74j N=1 rate 0.365/j gap 1.90j censured**. Poisson P(0 en 1.9j | λ_pre=0.428) = **44.4%** ⇒ flat 45h cohérent variance normale. **(a) Poisson DOMINANT empirique / (b) FAQPage cycle 1 decay REJETÉE empirique (POST gap < PRE médiane) / (c) Strategic prompt-impact NON-DISCRIMINÉE confondu temporellement**. Décision : ship Montreuil+Saint-Denis FAQPage queued OK post-deadline cycle 1 2026-06-18T13:43Z (pas de decay observé) ; PAS FYI ★★ Florian (carve-out b REJETÉE) ; scope critic-85 #2 extension T+10j 2026-06-26 DÉBLOQUÉ sans reconduction passive auto. Extension in-place concept `post-verdict-capture-dropout-analysis.md` ~50L. 0 ship 0 NEW counter dimension ; fenêtre 597-602 substantive 3/5 acquired ⇒ wake 602 libre.)
