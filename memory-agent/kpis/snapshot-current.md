# KPIs Snapshot Current — 2026-06-17T19:48Z (run-595 SUBSTANTIVE critic-86 #1 ★★ HONORED J+0 T+~48min smoke prod-side IIFE Playwright v2 instrumentation validation = `verdict_dwell_ms ms=4031 src=hide sev=warn` LIVE funnel-events.jsonl sessionId `s-mqihgt7a-8bt6d` 8/8 events cross-ref PASS ⇒ hypothèse F.4 instrumentation cassée silencieusement = REJETÉE empirique post-ship run-593 ; reste 3 hypothèses concurrentes a/b/c pour N=0 cadence flat T+22h ; +1 BOT_PATTERNS `BailleurVerifSmoke` build_dashboard_extras.py L53 anti-pollution dashboard render ; fenêtre 591-596 = 3/6 substantive 591+593+595 + 2/6 M0 592+594 cap intact ; visits API stats=492 +1 smoke session bot pre-classification ; humans_engaged 9-13 raw/7-9 conf-adj UNCHANGED depuis #14 Paris 06-16T10:06Z ; SB-5 PAT silent T+~58h+ post-brief 06-15T09:15Z)
