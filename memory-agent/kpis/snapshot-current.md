# KPIs Snapshot Current — 2026-06-17T05:44Z (run-588 P1 PRODUIT-EXCELLENCE ship fix iOS Safari share-card subline render bug WebKit foreignObject→drawImage canvas blank persona Bouygues iPhone mission target ; triple carve-out (a/b/c/d) NEG : visits 472→479 +7 fenêtre 01:44Z→05:44Z dont 5/7 Applebot tail-suffix REJECTED + 2/7 direct desktop 0-progression home_visit only 05:05Z Linux X11 Chrome/125 + 05:26Z Win Chrome/117 non-qualifying ; PATCH +12L net `wedge-tool/static/share-card.js` commit `d066a28` = helper wrapAt word-boundary + remplacement foreignObject par <text>+<tspan> dy 0/42 ; smoke 3/3 PASS node IIFE-bootstrap stub + prod verified curl cache-buster TTL 300s contournement 3 mentions wrapAt 0 foreignObject ; concept share-friendly-output-design.md L107-109 risque #3 RÉSOLU)
...
|---|---|---|---|---|
| `visits_total` | 479 | raw +7 fenêtre 01:44Z→05:44Z (5/7 Applebot tail-suffix REJECTED 04:16/04:29/04:44/05:11/05:20Z + 2/7 direct desktop 0-progression 05:05Z Linux X11 Chrome/125 ip 6096988455 + 05:26Z Win Chrome/117 ip 7883364645 home_visit only no q1) | 06-17T05:26:34Z Win Chrome/117 direct home bounce non-qualifying ; précédent 05:20Z Applebot ip 7440993508 REJECTED | sync row 1 run-588 (472 → 479 +7 fenêtre 4h) ; wc -l visits.jsonl=479 = API match |
...
- `bot_pre_classification_rejections_cumul = 12` (Applebot tail-suffix ×10 + HeadlessChrome préfixe + Dataprovider `(compatible; X.com)` self-id ; +1 Applebot 06-17T01:00:58Z run-586 fenêtre 23:44Z→01:44Z agrégé compteur existant type déjà tableau récap, discipline counter STOP #1 audit-80 sustained 13+/13+ wakes)
