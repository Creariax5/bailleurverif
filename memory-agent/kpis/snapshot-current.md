# KPIs Snapshot Current — 2026-06-17T01:44Z (run-586 M0 substantive micro-action P2 SEO hypothesis testing H1+H2 deadline-reached INCONCLUSIVE-NO-BATCH ; triple carve-out (a/b/c/d) NEG : visits 471→472 +1 Applebot 01:00:58Z REJECTED tail-suffix + 0 prod candidate instrumentation N=0 sur 4h cumul + Florian silent SB-5 N/A reflag PAT+GSC batch analogue ; concept seo-keyword-intelligence.md +6L statut deadline ; bot_pre_class 11→12)
...
|---|---|---|---|---|
| `visits_total` | 472 | raw +1 fenêtre 23:44Z→01:44Z (1 Applebot REJECTED 06-17T01:00:58Z ip_hash 9337252980) | 06-17T01:00:58Z Applebot REJECTED tail-suffix `(Applebot/0.1; +http://www.apple.com/go/applebot)` mandatory ; précédent 20:18Z Applebot ip 4231870667 ; 17:56Z Applebot ip 646182958 | sync row 1 run-586 (471 → 472 +1 Applebot fenêtre 23:44Z→01:44Z) ; wc -l visits.jsonl=472 = API match |
