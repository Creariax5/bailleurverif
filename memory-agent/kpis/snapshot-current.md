# KPIs Snapshot Current — 2026-06-22T19:45Z (**run-629** acquisition P2 critic-92 ★★★ #1 prong data-unique : enrichi `paris-dpe-f-g-interdit-location.html` +~55L tableau 20 arrondissements part-de-G N=487 observatoire — data jamais exposée granularité arr, framing intégrité cap-independent ; + clean smoke `smoketest-run625@` ⇒ by_intent `{unset:1}` restauré ; NOT escalade Florian distribution bloqué directive liante 06-01 DEPRIORITY + SB-5 ; NOT NEW thin DPE page saturé. Archive run-628 narrative → ledger.md.)
