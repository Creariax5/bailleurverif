...
# 301 redirect map (thin-page pruning, P0-3 brief Florian 2026-06-26). Source files
# remain on disk → reversible by removing entries. Regenerated by audit_thin_dpe.py.
REDIRECTS_301 = {}
try:
    with open(os.path.join(ROOT, "redirects-301.json"), encoding="utf-8") as _rf:
        REDIRECTS_301 = json.load(_rf)
except Exception:
    REDIRECTS_301 = {}
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        _target = REDIRECTS_301.get(path)
        if _target:
            self.send_response(301)
